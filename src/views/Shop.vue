          ...
          <div class="deal-leftmk left-side">
            ...
            <div class="special-sec1">
              <div class="col-xs-4 img-deals">
                <img :src="require('@/assets/images/s4.jpg')" alt="" />
              </div>
              <div class="col-xs-8 img-deal1">
                <h3>Shuberry Heels</h3>
                <router-link to="/single">$180.00</router-link>
              </div>
              <div class="clearfix"></div>
            </div>
            <div class="special-sec1">
              ...
              <div class="col-xs-8 img-deal1">
                ...
                <router-link to="/single">$99.00</router-link>
              </div>
              <div class="clearfix"></div>
            </div>
            <div class="special-sec1">
              ...
              <div class="col-xs-8 img-deal1">
                <h3>Bella Toes</h3>
                <router-link to="/single">$165.00</router-link>
              </div>
              <div class="clearfix"></div>
            </div>
            <div class="special-sec1">
              <div class="col-xs-4 img-deals">
                <img :src="require('@/assets/images/s5.jpg')" alt="" />
              </div>
              <div class="col-xs-8 img-deal1">
                <h3>Red Bellies</h3>
                <router-link to="/single">$225.00</router-link>
              </div>
              <div class="clearfix"></div>
            </div>
            <div class="special-sec1">
              ...
              <div class="col-xs-8 img-deal1">
                <h3>(SRV) Sneakers</h3>
                <router-link to="/single">$169.00</router-link>
              </div>
              <div class="clearfix"></div>
            </div>
          </div>
          ...
          <div class="wrapper_top_shop">
            ...
            <div class="product-sec1">
              ...
              <template v-for="(product,index) in products">
                <div class="col-md-4 product-men" :key="index">
                  <div class="product-shoe-info shoe">
                    <div class="men-pro-item">
                      ...
                      <div class="item-info-product">
                        <h4>
                          <router-link to="/single">{{ product.title }}</router-link>
                        </h4>
