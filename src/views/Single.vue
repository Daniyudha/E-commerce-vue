      ...
      <div class="shop_inner_inf">
              ...
              <ul class="slides">
                <li data-thumb="images/d2.jpg">
                  <div class="thumb-image">
                    <img
                      :src="require('@/assets/images/d2.jpg')"
                      data-imagezoom="true"
                ...
                <li data-thumb="images/d3.jpg">
                  <div class="thumb-image">
                    <img
                      :src="require('@/assets/images/d3.jpg')"
                      data-imagezoom="true"
                      class="img-responsive"
                    />
                  </div>
        ...
        <div class="col-md-8 single-right-left simpleCart_shelfItem">
          ...
          <div class="occasional">
            ...
            <div class="colr ert">
              <label class="radio"
                ><input type="radio" name="radio" checked="" /><i></i>Casual
                Shoes</label
              >
            </div>
            <div class="colr">
        ...
        <div class="new_arrivals">
          ...
          <div class="col-md-3 product-men women_two">
            <div class="product-shoe-info shoe">
              <div class="men-pro-item">
                <div class="men-thumb-item">
                  <img :src="require('@/assets/images/s7.jpg')" alt="" />
                  <div class="men-cart-pro">
                    <div class="inner-men-cart-pro">
                      <a href="single.html" class="link-product-add-cart"
                        >Quick View</a
          ...
          <div class="col-md-3 product-men women_two">
            <div class="product-shoe-info shoe">
              <div class="men-pro-item">
                <div class="men-thumb-item">
                  <img :src="require('@/assets/images/s8.jpg')" alt="" />
                  <div class="men-cart-pro">
                    <div class="inner-men-cart-pro">
                      <a href="single.html" class="link-product-add-cart"
                        >Quick View</a
